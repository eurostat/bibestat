...
*  <a name="html"></a>**[*html/*](html)**: in `html`, like in the searchable table below (see also link in _About_ section [above](#About)): 

<p style="text-align:center;"><a href="https://raw.githack.com/eurostat/bibestat/master/html/eurostatref.html"><img src="docs/html.png" alt="html table" width="600" style="margin-left:auto;margin-right:auto;"></a></p>
